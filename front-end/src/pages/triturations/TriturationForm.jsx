...
export default function TriturationForm() {
  ...
  const rendement =
    form.quantite && form.quantitéHuile
      ? ((parseFloat(form.quantitéHuile) / parseFloat(form.quantite)) * 100).toFixed(1)
      : null;
  ...
  return (
    <div className="max-w-xl mx-auto">
      <h1 className="text-2xl font-bold text-gray-800 mb-6">Nouvelle Trituration</h1>
          ...
          {rendement !== null && (
            <div className="flex items-center gap-3 p-3 bg-[#edf7ee] border border-[#059669]/30 rounded-lg">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-[#059669]">{rendement}%</p>
              </div>
            </div>
          )}
