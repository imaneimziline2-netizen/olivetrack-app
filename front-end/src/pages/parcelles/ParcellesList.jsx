...
import { deleteParcelle } from "../../../store/slices/parcelleSlice.js";
...
function ParcellesList() {
    ...
    const [selectedParcelleToDelete, setSelectedParcelleToDelete] =
        useState(null);
    ...
    const handleDelete = async () => {
        ...
        const result = await dispatch(
            deleteParcelle(selectedParcelleToDelete._id),
        );
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        Gérez vos parcelles, superficies, variétés et modes de
                        culture
                    </p>
                </div>
                <Button
            ...
            {loading ? (
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between gap-2 mt-4 pt-3 border-t border-gray-100">
                                <Button
                                    variant="outline"
                                    onClick={() =>
                                        navigate(`/parcelles/${parcelle._id}`)
                                    }
                                ...
                                <Button
                                    variant="danger"
                                    onClick={() =>
                                        setSelectedParcelleToDelete(parcelle)
                                    }
                                    className="text-xs py-2 px-3"
                                    title="Supprimer"
                                >
                ...
                <div className="text-center py-20 bg-white rounded-3xl border border-dashed border-gray-200 p-8">
                    ...
                    <p className="text-xs text-gray-500 max-w-sm mx-auto mt-1">
                        ...
                        enregistrer des récoltes et calculer vos rendements.
                    </p>
                    <Button
                        variant="primary"
                        onClick={() => navigate("/parcelles/new")}
