                    ...
                    >
                        <img
                            ...
                            onError={(e) => {
                                ...
                                e.target.src = "https://ui-avatars.com/api/?name=Hassan+El+Mansouri&background=059669&color=fff";
                            }}
                        />
                        <div className="hidden sm:block text-left">
                            ...
                            <p className="text-[11px] text-gray-400 leading-tight mt-0.5">
                                {user?.role === "admin" ? "Administrateur" : "Exploitant agricole"}
                            </p>
                        </div>
                        <svg
                        ...
                        <>
                            ...
                            <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-100 py-1.5 z-40 animate-in fade-in zoom-in-95 duration-100 text-xs">
                                <div className="px-4 py-2 border-b border-gray-100">
                                    <p className="font-bold text-gray-900">{user?.nom || "Hassan El Amrani"}</p>
                                    <p className="text-gray-400 text-[11px] truncate">{user?.email || "agriculteur@olivegrove.ma"}</p>
                                </div>
                                <button
                                    onClick={() => {
                                        navigate("/profile");
